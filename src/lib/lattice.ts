 ...
 *
 *   * the lanes, as `GET /v1/archipelagos/:id/lanes` serves them (`aetherholm/src/server.ts:518`)
 *     — per-direction `travelSeconds`, already rolled from the season seed;
 *   * the class table, as `GET /v1/content/airships` serves it (`aetherholm/src/server.ts:490`),
 ...
 * 409 `no_route` (`aetherholm/src/server.ts:290`), so the composer disables the commit instead
